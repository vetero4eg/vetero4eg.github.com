		...
		*/
		attach: function(userOptions) {
			...
			if (options.binded) {
				...
				// bind fields
				form.find("["+options.validateAttribute+"*=validate]").not("[type=checkbox]").not("[type=radio]").not(".datepicker").keypress(options.validationEventTrigger, methods._onFieldEvent);
