...
*/  
  ...
  pentas
  .staggerTo(".pent", 5, { ease: Back.easeInOut.config(1.2), rotation: -Math.floor(Math.random() * 1 + 5), strokeOpacity: 0.6, repeat: -1, yoyo: true }, 0.3);
  ...
  $(".pentas").hover(
   ...
   //menu two level 
    ...
    $(".benefit__icon").hover(
      function() {
        benIcHover.to($(this).find("svg"), 0.5, {
          scale: 1.2, ease: Elastic.easeOut.config(1.2, 0.3)
        });
      },
      function() {
        benIcHover.to($(this).find("svg"), 0.5, {
  ...
  //source
    ...
    .fromTo(".source-svg svg", 2.5, {strokeDashoffset: "1400", strokeDasharray: "1400 1400"}, {strokeDashoffset: "0", strokeDasharray: "1400 0"}, "-=1")
  ...
  //form
    $("body").on("submit", ".callback-form", function(e) {
        ...
        $(".form").css({"background": "url(../img/girl-two.jpg) top left 18% no-repeat", "-webkit-background-size": "auto 95%", "background-size": "auto 95%"});
