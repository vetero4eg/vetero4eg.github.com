...
//scrollTop - появление кнопки реализовано в рамка анимации скроллинга
    const speed = 550;
    $scrollTop = $(".scrollTop");
...
//pentas
  ...
  pentasHoverE
  .staggerTo(".pent:even", 0.3, { x: -12, y: -20, scale: 0.9}, 0.01, "0");

  pentasHoverO
    .staggerTo(".pent:odd", 0.3, { x: 12, y: 20, scale: 0.9 }, 0.01, "0");
  ...
  $(".pentas").hover(
    ...
    function() {
      pentasHoverE.reverse();
      pentasHoverO.reverse();
    });

//mouse icon 
			$('.scroller').bind('click.smoothscroll', function (e) {
			  e.preventDefault();
